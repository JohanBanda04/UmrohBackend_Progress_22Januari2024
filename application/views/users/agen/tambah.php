                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-control default-select2"
                                                name="cabang_id" id="cabang_id" selected="<?php echo $query->role_agen_id; ?>"
                                                >
...
<!--                                        <small class="lh-1" style="color: red"><i>.jpeg .jpg .png (*wajib)</i></small>-->
                                        <small class="lh-1" style="color: red"><i>.jpeg .jpg .png </i></small>
                                    </div>
                                </div>
                            ...
                            <a style="background-color: #a89292;float: right; margin-right:10px"
                               href="<?php echo $link1; ?>/<?php echo $link2; ?>/<?= $nama_role_agen;?>/<?= hashids_encrypt($id_role_agen);?>" class="btn btn-default">
                                <<
                                Kembali</a>
                        </form>
                    </div>
