...
<div class="content-wrapper">
    ...
    <div class="content">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <fieldset class="content-group">
                            ...
                            <form class="form-horizontal" action="" data-parsley-validate="true" method="post"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-lg-3">Jumlah Pencairan</label>
                                        <div class="col-lg-9">
                                            ...
                                            <input style="color: black; font-weight: bold"
                                                   ...
                                                   class="form-control"
                                                   value="" placeholder="Jumlah Pencairan">
                                        </div>
                                    </div>
                        ...
                        <input style="float:right;" type="submit" id="btnsimpan_pencairan" name="btnsimpan_pencairan"
                               class="btn btn-primary" value="Kirim"/>
        ...
        <script type="text/javascript">
            $(document).on('click', '#btnsimpan_pencairan', function () {
