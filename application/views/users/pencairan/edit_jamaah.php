                        ...
                        <form class="form-horizontal" action="" data-parsley-validate="true" method="post"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-control default-select2"
                                                name="pilihan_paket_edit" id="pilihan_paket_edit" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="jenis_paket_edit" id="jenis_paket_edit"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-3">Uang Muka</label>
                                    <div class="col-lg-9">
                                        <?php
                                        $id_paket_haji = "";
                                        ?>
                                        <select name="uang_muka_edit" id="uang_muka_edit"
                                                class="form-control default-select2" required>

                                            <option value="">-Uang Muka-</option>
                                            <?php if ($pilihan_paket == "paket_haji") {
                                                $data_haji = $this->db->get("tbl_paket_haji", array(
                                                    "id_paket_haji" => $id_paket,
                                                ))->row();
                                                $data_dp = $this->db->get_where("tbl_dp", array(
                                                    "id_dp" => $data_haji->dp_id,
                                                ))->row();
                                                ?>

                                                <option <?php if ($data_dp->harga_dp1 == $dt_dp) {
                                                    echo "selected";
                                                } ?> value="<?= $data_dp->harga_dp1; ?>">
                                                    Rp <?php echo number_format($data_dp->harga_dp1); ?>
                                                </option>
                                                <option <?php if ($data_dp->harga_dp2 == $dt_dp) {
                                                    echo "selected";
                                                } ?> value="<?= $data_dp->harga_dp2; ?>">
                                                    Rp <?php echo number_format($data_dp->harga_dp2); ?>
                                                </option>

                                                <?php
                                            } else if ($pilihan_paket == "paket_umroh") {
                                                $data_umroh = $this->db->get("tbl_paket_umroh", array(
                                                    "id_paket_umroh" => $id_paket,
                                                ))->row();
                                                $data_dp = $this->db->get_where("tbl_dp", array(
                                                    "id_dp" => $data_umroh->dp_id,
                                                ))->row();
                                                ?>
                                                <option <?php if ($data_dp->harga_dp1 == $dt_dp) {
                                                    echo "selected";
