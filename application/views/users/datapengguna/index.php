        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <a href="datapengguna/data_pengguna/role/id/t_agen.html" class="btn btn-primary"><i
                                class="fa fa-plus-circle"></i> Tambah <?php echo $judul_web." "; ?> / Agen</a>
                        ...
                        <table id="data-table" class="table table-striped table-bordered">
                            ...
                            foreach ($query->result() as $baris):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $get_data_role = $this->db->get_where("tbl_role_agen",
                                            array(
                                                    "id_role_agen"=>$baris->role_agen_id
                                            ))->row();

                                        $get_nama_role_lengkap = $get_data_role->nama_role_agen_lengkap;
                                        $get_nama_role = $get_data_role->nama_role_agen;
                                        ?>
                                        <?= $baris->nama_agen;?>
                                        <?php
                                        if($get_nama_role=="presiden_direktur"){?>
                                            <label for="label" class="label" style="background-color: #00AAFF"><?= $get_nama_role_lengkap?></label>

                                        <?php } else if($get_nama_role=="direktur_mujahid"){
                                            ?>
                                            <label for="label" class="label" style="background-color: #369c13"><?= $get_nama_role_lengkap?></label>
                                            <?php
                                        }else if($get_nama_role=="manajer_mujahid"){
                                            ?>
                                            <label for="label" class="label" style="background-color: #d7496f"><?= $get_nama_role_lengkap?></label>
                                            <?php
                                        }else if($get_nama_role=="baitullah_mujahid"){
                                            ?>
                                            <label for="label" class="label" style="background-color: #a89292"><?= $get_nama_role_lengkap?></label>
                                            <?php
                                        }
                                        ?>
                                    </td>
                                    ...
                                    ?>
                                    <td><?= $baris->tempat_lahir." / ".$tgl_lahir_agen[0]." ".$tgl_lahir_agen[1]." ".$tgl_lahir_agen[2]; ?></td>
                                    <td>
                                        <?php
                                    ...
                                    <td align="center">
                                        ...
                                        <?php
                                        $data_role_agen = $this->db->get_where("tbl_role_agen",
                                            array(
                                                    "id_role_agen"=>$baris->role_agen_id
                                            ))->row();
                                        $nama_role_agen = $data_role_agen->nama_role_agen;
                                        $id_role_agen = $data_role_agen->id_role_agen;

                                        ?>

                                        <a href="datapengguna/data_pengguna/<?php echo $nama_role_agen;?>/<?php echo hashids_encrypt($baris->id_agen); ?>/e_agen/<?php echo hashids_encrypt($id_role_agen);?>"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form method="POST"
                                                      action="datapengguna/data_pengguna/<?php echo $nama_role_agen;?>/<?php echo hashids_encrypt($baris->id_agen); ?>/h_agen/<?php echo $id_role_agen;?>">
