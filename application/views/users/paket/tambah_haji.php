        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="nama_paket"
                             ...
                             value="" placeholder="Nama Paket Haji"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="number" name="harga_paket"
                                   id="harga_paket" class="form-control"
                                   value="" placeholder="Harga Paket Haji"
                                   required autofocus onfocus="this.value = this.value;">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="number" name="jumlah_hari"
                                   id="jumlah_hari" class="form-control"
                                   value="" placeholder="Jumlah Hari Haji"
                                   required autofocus onfocus="this.value = this.value;">
                        </div>
                    </div>
                  ...
                  <button type="submit" name="btnsimpan_haji" class="btn btn-primary" style="float:right;">Simpan</button>
                </form>
            </div>
