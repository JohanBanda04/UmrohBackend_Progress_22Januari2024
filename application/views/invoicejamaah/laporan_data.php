    ...
    <div id="mainContent" class="" >
        <form action="<?php echo $link1; ?>/v/f.html" class="col-lg-12 justify-content-center" method="post" >
            <div class="row justify-content-center p-15">
                <h5 class="m-0 font-weight-bold">KKalenderr Laporan</h5>
                <?php /*echo $link1; */?><!-- <br>
                <?php /*echo $link2; */?> <br>
                --><?php /*echo $link3; */?>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <table
                        ...
                        <tr>
                            ...
                            <th hidden style="text-align: center">Jam</th>
                    ...
                    <div style="text-align: center; font-weight: bold">
                        <a href="<?php echo $link1; ?>/v/ccs.html"
                           class="" title="Download"
                           onclick="" target="_blank">
                            <i class="fa fa-print btn btn-danger" style="padding: 10px"> sDownload PDF </i>
